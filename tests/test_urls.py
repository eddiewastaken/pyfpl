import unittest
from urls import GameUrls, ManagerUrls, LeagueUrls  # Import your classes from the module


class UrlsTests(unittest.TestCase):
    def test_overview_returns_correct_url(self):
        self.assertEqual("https://fantasy.premierleague.com/api/bootstrap-static/", GameUrls().overview())

    def test_fixtures_returns_correct_url(self):
        self.assertEqual("https://fantasy.premierleague.com/api/fixtures/", GameUrls().fixtures())

    def test_player_stats_returns_correct_url(self):
    ...
    def test_gameweek_stats_returns_correct_url(self):
...
class ManagerUrlsTests(unittest.TestCase):
    ...
    def test_transfer_history_returns_correct_url(self):
    ...
    def test_starting_lineup_returns_correct_url(self):
    ...
    def test_performance_history_returns_correct_url(self):
